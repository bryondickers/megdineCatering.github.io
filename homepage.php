        ...
        <div class="carousel-inner bg-info mx-auto">
            <div class="img carousel-item active">
                ...
                <div class="carousel-caption float-none">
                    <p class="para text-center py-0">  <span class="text-uppercase">
                            <br><b>The taste is all we deliver</b></span>
                   <br> Life is endlessly delicious with <br>our team, come get your favourite taste now</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="images/pic2.jpg" alt="" class="mx-auto d-block">
                <div class="carousel-caption float-none">
                    <p class="text-center py-0">  <span class="bol text-uppercase"><b>The taste is all we deliver</b></span>
                        <br> Life is endlessly delicious with <br>our team, come get your favourite taste now</p>
                </div>
            </div>
            <div class="carousel-item">
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption float-none">
                    <p class="text-center py-0">  <span class="text-uppercase"><b>The taste is all we deliver</b></span>
                        <br> Life is endlessly delicious with <br>our team, come get your favourite taste now</p>
                </div>
            </div>
            <div class="carousel-item">
